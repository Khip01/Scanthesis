...
class ChatsDummy {
  static final List<Chat> chats = [
    Chat(
      ...
      response: ApiResponse('Ringkasan dokumen 1 yang berisi tiga paragraf.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('Abstrak dokumen 2.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('Kata kunci dari dokumen 3 adalah AI, Machine Learning, Data.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('Kesimpulan dokumen 4 adalah tentang dampak teknologi di era digital.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('This is the English translation of document 5.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('Ringkasan singkat dari dokumen 6 dalam satu paragraf.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('Analisis ekonomi dokumen 7 menyebutkan tren positif di sektor keuangan.'),
    ),
    Chat(
      request: ApiRequest(
    ...
    Chat(
      ...
      response: ApiResponse('Dokumen 9 telah ditulis ulang dengan bahasa sederhana.'),
    ),
    Chat(
      request: ApiRequest(
      ...
      response: ApiResponse('1. Pendahuluan\n2. Metodologi\n3. Hasil\n4. Kesimpulan'),
    ),
  ];
}
